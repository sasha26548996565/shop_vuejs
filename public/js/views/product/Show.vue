<template>
  <div>
    <main>
      ...
      <section class="shop-details-top two" v-if="product">
        <div class="container">
          <div class="row mt--30">
              ...
              <div class="shop-details-top-right">
                <div class="shop-details-top-right-content-box">
                  ...
                  <div class="shop-details-top-size-box">
                    ...
                    <div class="shop-details-top-size-list-box">
                      <ul class="shop-details-top-size-list">
                        <template v-for="productGroup in product.group_products" :key="productGroup.id">
                          <li v-for="size in productGroup.sizes" :key="size.id"><a href="#0">{{ size.title }}</a></li>
                        </template>
                      </ul>
                  ...
                  <div class="shop-details-top-color-sky-box">
                    ...
                    <ul class="varients">
                      <template v-for="productGroup in product.group_products" :key="productGroup.id">
                        <li v-for="color in productGroup.colors" :key="color.id">
                          {{ color.title }}
                        </li>
                      </template>
                    </ul>
              ...
              >
                <div class="product-drescription">
                  ...
                  <p>
                    ...
                    service without clicks-and-mortar e-services. Proactively
                    cultivate go forward testing procedures with accurate
                    quality vectors. Globally aiembrace ethical functionalities
                    via empowered scenarios. Phosfluorescently restore highly
                    efficient opportunities and client-focused infomediaries.
                    Enthusiastically transition multidisciplinary outside the
                    box thinking without premium networks. Progressive supply
                    clicks-and-mortar human capital through enterprise-wide web
                    services. Objectivey bester provide access to extensible
                    processes better than more qulification dumber there
                    stoaling through 24/365 solutions.
                  </p>
                ...
                <div class="product-drescription">
                  ...
                  <div class="review-single">
                    <div class="left">
                      ...
                      <h6>
                        Amazing Theme
                        <span>Kurt Morgan on January 28, 2022</span>
                      </h6>
                      <p>
                        Assertively conceptualize parallel process improvements
                        through user friendly colighue to action items.
            ...
            <div class="catagory-slider">
              <div class="products-grid-one">
                <div class="products-grid-one__product-image">
                  ...
                  >
                    <img src="http://localhost:5173/src/assets/images/shop/products-img1.jpg" alt="Alt" />
                  </a>
              ...
              <div class="products-grid-one">
                ...
                <div class="products-grid-one__thumb-box">
                  <p class="products-grid-one__product-varient">
                    ...
                    <img src="http://localhost:5173/src/assets/images/shop/products-img3.jpg" alt="Alt" />
                  </p>
                  <p class="products-grid-one__product-varient">
                    <span class="color"> blue </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img4.jpg" alt="Alt" />
                  </p>
                  <p class="products-grid-one__product-varient">
                    <span class="color"> Black </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img5.jpg" alt="Alt" />
                  </p>
                </div>
              </div>
              <div class="products-grid-one">
              ...
              <div class="products-grid-one">
                ...
                <div class="products-grid-one__thumb-box">
                  <p class="products-grid-one__product-varient">
                    <span class="color"> blue </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img6.jpg" alt="Alt" />
                  </p>
                  <p class="products-grid-one__product-varient">
                    <span class="color"> Yellow </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img5.jpg" alt="Alt" />
              ...
              <div class="products-grid-one">
                ...
                <div class="products-grid-one__thumb-box">
                  ...
                  <p class="products-grid-one__product-varient">
                    <span class="color"> Yellow </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img7.jpg" alt="Alt" />
                  </p>
                  <p class="products-grid-one__product-varient">
                    <span class="color"> green </span>
                    <img src="http://localhost:5173/src/assets/images/shop/products-img8.jpg" alt="Alt" />
                  </p>
                </div>
              </div>
              <div class="products-grid-one">
...
export default {
  ...
  methods: {
    getProduct() {
      this.axios.get(`http://127.0.0.1:8000/api/products/show/${this.$route.params.id}`)
      .then((response) => {
